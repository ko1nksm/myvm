...
define_keymap() {
  ...
  keymap '`:KEY_GRAVE'
  keymap '~:KEY_LEFTSHIFT KEY_GRAVE'
  keymap '!:KEY_LEFTSHIFT KEY_1'
  keymap '@:KEY_LEFTSHIFT KEY_2'
  keymap '#:KEY_LEFTSHIFT KEY_3'
  keymap '$:KEY_LEFTSHIFT KEY_4'
  keymap '%:KEY_LEFTSHIFT KEY_5'
  keymap '^:KEY_LEFTSHIFT KEY_6'
  keymap '&:KEY_LEFTSHIFT KEY_7'
  keymap '*:KEY_LEFTSHIFT KEY_8'
  keymap '(:KEY_LEFTSHIFT KEY_9'
  keymap '):KEY_LEFTSHIFT KEY_0'
  keymap '-:KEY_MINUS'
  keymap '_:KEY_LEFTSHIFT KEY_MINUS'
  keymap '=:KEY_EQUAL'
  keymap '+:KEY_LEFTSHIFT KEY_EQUAL'
  ...
  keymap '::KEY_LEFTSHIFT KEY_SEMICOLON'
  keymap "'\\'':KEY_APOSTROPHE"
  keymap '":KEY_LEFTSHIFT KEY_APOSTROPHE'
  keymap ',:KEY_COMMA'
  keymap '<:KEY_LEFTSHIFT KEY_COMMA'
  keymap '.:KEY_DOT'
  keymap '>:KEY_LEFTSHIFT KEY_DOT'
  keymap '/:KEY_SLASH'
  keymap '|:KEY_LEFTSHIFT KEY_SLASH'
}
